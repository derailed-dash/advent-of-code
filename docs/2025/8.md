...
<video width="100%" controls autoplay loop muted>
  <source src="/assets/images/2025-08-vis.mp4" type="video/mp4">
...
This creates a visual timeline of the algorithm's progress. You can literally see the "heat" of the activity moving through the cloud of points. I also added a "camera zoom" effect at the end to pull focus onto the completed structure. 

I exported this using `ffmpeg` to get a crisp MP4, because let's be honest, 256-colour GIFs are *so* 1987.
