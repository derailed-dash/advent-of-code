...
I created a 3D visualization using `matplotlib` to show the circuits merging. The flash effect indicates when a connection reduces the total number of circuits.

![Day 8 Visualization](/assets/images/2025-08-vis.gif)
